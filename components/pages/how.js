...
const How = () => {
  ...
  return (
    <figure className="px-6 py-20 my:40 lg:py-32 bg-gradient-to-b from-white to-gray-50">
      <motion.h1
      ...
      <div className="max-w-5xl mx-auto text-center space-y-10">
        ...
        <motion.div
          ...
          ref={ref}
          className="w-full h-full max-w-4xl mx-auto shadow-2xl rounded-xl overflow-hidden"
        >
          
          <Iframe
            className="w-full h-full md:w-48 md:h-auto md:rounded-none rounded-full mx-auto"
